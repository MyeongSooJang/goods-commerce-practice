...
import com.example.member.presentation.web.dto.AuthSessionListResponse;
...
public class AuthLogoutController {
    ...
    public ResponseEntity<ApiResponse<AuthSessionListResponse>> getSessions(
        ...
        return ResponseEntity.ok(ApiResponse.success(
                AuthSessionListResponse.from(
                        authService.getSessions(authenticatedMember.memberId(), authenticatedMember.sessionId())
                )
        ));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> logoutCurrentSession(
        ...
        authService.logoutCurrentSession(authorizationHeader);
        return ResponseEntity.ok(ApiResponse.success(null));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> logoutAllSessions(
        ...
        authService.logoutAllSessions(authorizationHeader);
        return ResponseEntity.ok(ApiResponse.success(null));
    }
}
